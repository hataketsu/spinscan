...
class UpdatedReceiver : BroadcastReceiver() {
    ...
    private fun postReopen(ctx: Context, open: Intent) {
        ...
        manager.createNotificationChannel(
            NotificationChannel(CHANNEL, ctx.getString(R.string.update_channel),
        ...
        manager.notify(NOTIFICATION_ID, Notification.Builder(ctx, CHANNEL)
            ...
            .setContentTitle(ctx.getString(R.string.updated_title))
            .setContentText(ctx.getString(R.string.updated_body))
